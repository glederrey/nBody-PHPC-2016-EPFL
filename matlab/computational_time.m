...
for i=1:length(nbr)
    ...
    filename = ['../results-computational-time/bf_', nbrStr{i}, '_time.dat'];
...
for i=1:length(nbr)-1
    ...
    filename = ['../results-computational-time/bh_', nbrStr{i}, '_0_time.dat'];
...
for i=1:length(nbr)
    ...
    filename = ['../results-computational-time/bh_', nbrStr{i}, '_05_time.dat'];
...
for i=1:length(nbr)
    ...
    filename = ['../results-computational-time/bh_', nbrStr{i}, '_1_time.dat'];
...
% for i=1:length(nbr)
%
%     filename = ['../results-computational-time/bh_', nbrStr{i}, '_2_time.dat'];
%
%     [total, simulation, loading, iteration, building, communication] = time(filename, algo, parallel);
%
...
% for i=1:length(nbr)
%
%     filename = ['../results-computational-time/bh_', nbrStr{i}, '_10_time.dat'];
%
%     [total, simulation, loading, iteration, building, communication] = time(filename, algo, parallel);
%
